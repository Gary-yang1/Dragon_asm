-- sqlc schema mirror of migrations/000021_create_project_workspace.up.sql.
ALTER TABLE project
...
CREATE TABLE project_subject (
    ...
    primary_slot TINYINT GENERATED ALWAYS AS (CASE WHEN is_primary = TRUE AND deleted_at = '1970-01-01 00:00:00.000' THEN 1 ELSE NULL END) STORED,
    PRIMARY KEY (id),
    ...
    CONSTRAINT fk_project_subject_project FOREIGN KEY (tenant_id, org_id, project_id) REFERENCES project (tenant_id, org_id, id) ON DELETE CASCADE,
...
CREATE TABLE project_domain_profile (
    ...
    CONSTRAINT fk_project_domain_project FOREIGN KEY (tenant_id, org_id, project_id) REFERENCES project (tenant_id, org_id, id) ON DELETE CASCADE,
    CONSTRAINT fk_project_domain_asset FOREIGN KEY (tenant_id, org_id, project_id, asset_id) REFERENCES asset (tenant_id, org_id, project_id, id) ON DELETE CASCADE,
    CONSTRAINT fk_project_domain_subject FOREIGN KEY (tenant_id, org_id, project_id, subject_id) REFERENCES project_subject (tenant_id, org_id, project_id, id) ON DELETE RESTRICT,
...
CREATE TABLE icp_filing (
    ...
    CONSTRAINT fk_icp_filing_project FOREIGN KEY (tenant_id, org_id, project_id) REFERENCES project (tenant_id, org_id, id) ON DELETE CASCADE,
    CONSTRAINT fk_icp_filing_subject FOREIGN KEY (tenant_id, org_id, project_id, subject_id) REFERENCES project_subject (tenant_id, org_id, project_id, id) ON DELETE RESTRICT,
...
CREATE TABLE icp_filing_domain (
    ...
    CONSTRAINT fk_icp_filing_domain_project FOREIGN KEY (tenant_id, org_id, project_id) REFERENCES project (tenant_id, org_id, id) ON DELETE CASCADE,
    CONSTRAINT fk_icp_filing_domain_filing FOREIGN KEY (tenant_id, org_id, project_id, filing_id) REFERENCES icp_filing (tenant_id, org_id, project_id, id) ON DELETE CASCADE,
    CONSTRAINT fk_icp_filing_domain_profile FOREIGN KEY (tenant_id, org_id, project_id, domain_profile_id) REFERENCES project_domain_profile (tenant_id, org_id, project_id, id) ON DELETE CASCADE
);
